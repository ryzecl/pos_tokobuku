...
// Get laporan data
$stmt = $pembelian->getLaporanPembelian($start_date, $end_date);
...
<head>
    ...
    <title>Laporan Pembelian - <?php echo APP_NAME; ?></title>
            ...
            <div class="content">
                ...
                <div class="dashboard-grid">
                    <div class="dashboard-card">
                        ...
                        <div class="card-value"><?php echo formatCurrency($total_pembelian); ?></div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-value"><?php echo $total_transaksi > 0 ? formatCurrency($total_pembelian / $total_transaksi) : 'Rp 0'; ?></div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-value"><?php echo $total_completed; ?> / <?php echo $total_transaksi; ?></div>
                        <div class="card-subtitle">Selesai / Total (Pending: <?php echo $total_pending; ?>)</div>
                    </div>
                </div>
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h3 class="table-title">Detail Laporan Pembelian</h3>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
